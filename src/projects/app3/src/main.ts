...
import {AuthUrlService as AbstractAuthUrlService} from "fx-app-shell";
import {AuthUrlService} from "fx-common-lib";
...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    { provide: AbstractAuthUrlService, useClass: AuthUrlService },
